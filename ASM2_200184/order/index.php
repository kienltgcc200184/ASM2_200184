                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr> 
                                ...
                                <td><?=$row['status']?></td>
                                <td>
                                    <a href = "update.php?id=<?=$row['OrderID']?>" class= "btn-warning rounded-pill"> Update</a>
                                </td>
                                <td><a href = "delete.php?id=<?=$row['OrderID']?>" class= "btn-warning rounded-pill"> Delete</a></td>
                            </tr>
                            <?php
                                }
                            ?>
