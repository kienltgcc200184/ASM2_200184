...
<!-- div content -->
    <div id="main"> 
        ...
        <div className="page-heading pb-2 mt-4 mb-2 ">
            <h3>Manager</h3> 
            <a href="index.php?id=<?=$_GET['id']?>&total=<?=$sumTotal[0]?>"><button type="button" class="btn btn-outline-primary">Save</button></a>
...
;                                            if(isset($_GET['odid'])){
                                            ...
                                            <input type="text" id="OrderDetail_ID" class="form-control"
                                                name="OrderDetail_ID" value ="<?=$_GET['odid']?? ''; ?>" <?=$d?>>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="Address-vertical">Product</label>
                                            <input class="form-control" list="p" name="Product_ID" id="Product_ID" value="<?=$lD[2]??''?>">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?=$resLP['Price']?></td>
                                <td><?=$resLP['Total']?></td>
                                <td><a href="insertDetail.php?id=<?=$resLP['Order_ID']?>&odid=<?=$resLP['OrderDetail_ID']?>" class="btn btn-warning rounded-pill">Update</a></td>
                                <td><a href="delete.php?oid=<?=$resLP['Order_ID']?>&odid=<?=$resLP['OrderDetail_ID']?>" class="btn btn-warning rounded-pill">Delete</a></td>
